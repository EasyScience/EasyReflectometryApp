...
def setupExePath() -> str:
    ...
    d = {
        'macos':
        os.path.join(CONFIG.setup_full_name, 'Contents', 'MacOS', CONFIG.setup_name),
        'ubuntu':
        CONFIG.setup_full_name,
        'windows':
        CONFIG.setup_full_name
    }
...
def runInstallerSilently():
    ...
    try:
        ...
        args = {'installer': setupExePath(), 'silent_script': silent_script_path}
