...
class Config():
    ...
    def __init__(self, branch_name=None):
        ...
        self.setup_name_suffix = f'_{self.setup_os}_' + \
            f'{self.setup_arch}_v{self.app_version}'
        ...
        self.maintenancetool_file = os.path.join(
            self.__dict__['ci']['project']['subdirs']['certificates_path'],
        ...
        self.certificate_zip_path = os.path.join(
            self.__dict__['ci']['project']['subdirs']['certificates_path'],
            'Codesigning.zip')
    ...
    def installationDir(self):
        dirs = {
            'macos': {
                ...
                '@ApplicationsDirUser@':
                str(pathlib.Path.home().joinpath('Applications'))
            },
            'ubuntu': {
                '@HomeDir@': str(pathlib.Path.home()),
                '@ApplicationsDir@': '/opt'
